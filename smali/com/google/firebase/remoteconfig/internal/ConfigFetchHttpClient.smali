...
.method public a()Ljava/net/HttpURLConnection;
    ...
    .line 5
    new-instance v1, Lb/d/b/r/i;

    invoke-virtual {v0}, Ljava/io/IOException;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lb/d/b/r/i;-><init>(Ljava/lang/String;)V
...
.method public fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Lb/d/b/r/q/k$a;
    .locals 6
    ...
    invoke-static {v3, v4}, Lb/d/a/b/c/s/a;->a(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    .line 9
    :cond_0
    invoke-static {v3, v1}, Lb/d/a/b/c/s/d;->a([BZ)Ljava/lang/String;
    ...
    .line 28
    new-instance p1, Lb/d/b/r/q/k$a;

    invoke-direct {p1, p7, v0, v2, v2}, Lb/d/b/r/q/k$a;-><init>(Ljava/util/Date;ILb/d/b/r/q/f;Ljava/lang/String;)V
    ...
    .line 30
    iput-object p7, p1, Lb/d/b/r/q/f$b;->b:Ljava/util/Date;
    :try_end_4
    ...
    iput-object p5, p1, Lb/d/b/r/q/f$b;->a:Lorg/json/JSONObject;
    :try_end_6
    ...
    iput-object p3, p1, Lb/d/b/r/q/f$b;->c:Lorg/json/JSONArray;
    :try_end_8
    ...
    :cond_4
    :try_start_9
    invoke-virtual {p1}, Lb/d/b/r/q/f$b;->a()Lb/d/b/r/q/f;
    ...
    .line 36
    new-instance p3, Lb/d/b/r/q/k$a;

    .line 37
    iget-object p4, p1, Lb/d/b/r/q/f;->c:Ljava/util/Date;

    .line 38
    invoke-direct {p3, p4, v1, p1, p2}, Lb/d/b/r/q/k$a;-><init>(Ljava/util/Date;ILb/d/b/r/q/f;Ljava/lang/String;)V
    ...
    .line 39
    new-instance p2, Lb/d/b/r/h;

    const-string p3, "Fetch failed: fetch response could not be parsed."

    invoke-direct {p2, p3, p1}, Lb/d/b/r/h;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p3, p2, p4}, Lb/d/b/r/k;-><init>(ILjava/lang/String;)V
    ...
    :goto_6
    :try_start_b
    new-instance p3, Lb/d/b/r/h;

    const-string p4, "The client had an error while calling the backend!"

    invoke-direct {p3, p4, p2}, Lb/d/b/r/h;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
